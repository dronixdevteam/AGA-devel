...
#define _BB_DIR_USR_SBIN _BB_DIR_SBIN
...
#endif
#ifdef CONFIG_UDHCPC
	APPLET(dhcpc, dhcpc_main, _BB_DIR_SBIN, _BB_SUID_NEVER)
#endif
#ifdef CONFIG_UDHCPD
        APPLET(dhcpd, dhcpd_main, _BB_DIR_USR_SBIN, _BB_SUID_NEVER)
#endif
	...
	APPLET(ledctrl, ledctrl_main, _BB_DIR_BIN, _BB_SUID_NEVER)
#endif
#ifdef CONFIG_LENGTH
