...
#define dhcpc_trivial_usage \
	"[-fbnqv] [-c CLIENTID] [-H HOSTNAME] [-i INTERFACE]\n[-p pidfile] [-r IP] [-s script]"
#define dhcpc_full_usage \
...
#define dhcpd_trivial_usage \
	"[configfile]\n" \

#define dhcpd_full_usage \
	""
