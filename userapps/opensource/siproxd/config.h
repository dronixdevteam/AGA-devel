...
#define HAVE_FUNC_OSIP_BODY_TO_STR_3

/* osip_message_parse takes 3 arguments */
#define HAVE_FUNC_OSIP_MESSAGE_PARSE_3

/* osip_message_set_body takes 3 arguments */
#define HAVE_FUNC_OSIP_MESSAGE_SET_BODY_3

/* osip_message_to_str takes 3 arguments */
#define HAVE_FUNC_OSIP_MESSAGE_TO_STR_3
